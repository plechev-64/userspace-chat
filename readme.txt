=== UserSpace Chat - Private messages, direct communication and general chats ===
Contributors: wppost
...
UserSpace Chat plugin allows you to communicate in private messages (DM - direct messages) through individual communication or use shared chats to communicate with your audience.
...
1. Upload dir `userspace-chat` to the `/wp-content/plugins/` directory
